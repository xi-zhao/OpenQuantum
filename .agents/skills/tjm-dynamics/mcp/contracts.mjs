...
export const definition = defineScienceTool({
  ...
  inputSchema: obj({ numQubits: count(2,3), coupling: finite(undefined,1), field: finite(undefined,0.5), dampingRate: finite(0,0.1), duration: finite(Number.MIN_VALUE,0.5), steps: count(2,10), trajectories: count(1,32), maxBondDimension: count(2,16), seed: int(0,2147483647,7), referenceMode: referenceModeSchema, execution: executionSchema }),
  resultSchema,
});
