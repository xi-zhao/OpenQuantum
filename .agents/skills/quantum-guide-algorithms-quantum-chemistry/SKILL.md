---
name: quantum-guide-algorithms-quantum-chemistry
description: "为 algorithms/quantum-chemistry 选择完整的开源算法工作流，路由到本地可发现的专用 Skills。"
...
本地开源适配。上游指南 ID：`algorithms/quantum-chemistry`。
...
上游 MIT 指南：[algorithms/quantum-chemistry](https://github.com/unitarylab/quantum-skills/blob/c5436bb120812ad903ac776f58df89b803ced48c/algorithms/quantum-chemistry/SKILL.md)。原文作为参考保存在固定检索库，本文件将执行路线改为开源 SDK。来源摘要和算法模块对应关系见[coverage.json](../../../examples/quantum-algorithms/coverage.json)，许可证与改动说明见[NOTICE](../../../examples/quantum-algorithms/NOTICE)。
