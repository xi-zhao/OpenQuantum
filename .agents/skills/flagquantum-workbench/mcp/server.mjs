...
Object.assign(env, { UV_PROJECT_ENVIRONMENT: path.join(projectRoot, ".openquantum/python-envs/flagquantum-workbench"), UV_LINK_MODE: "copy", PYTHONNOUSERSITE: "1", PYTHONDONTWRITEBYTECODE: "1", OMP_NUM_THREADS: "1", MKL_NUM_THREADS: "1" });
