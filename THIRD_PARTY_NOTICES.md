...
| UnitaryLab Algorithms（部分开源适配） | MIT | 从 `a8362e37` 的 Trotter/qDrift 适配产品公式到 Qiskit；原始版权、许可、源码摘要及修改声明位于 `.agents/skills/hamiltonian-simulation/`。不分发或依赖 UnitaryLab 模拟器；Qiskit、NumPy、SciPy 及传递依赖固定于 uv.lock | [unitarylab_algorithms](https://github.com/unitarylab/unitarylab_algorithms) |
