...
const sourcePaths = tracked.filter(file =>
  ...
  /^(src\/lib\/(candidate-circuit.mjs|candidate_science.py|bounded-science-mcp.mjs|local-compute-policy.mjs|science-execution.mjs|local-json-process.mjs)|tests\/(candidate-|flagquantum-|harness-candidate-|fixtures\/candidate-))/.test(file) ||
...
const summary = {
  schemaVersion: "1.0", verifiedAt: new Date().toISOString(), implementationBase: "3f43b6e", integrationBase: "e92bf0bacc24da3a548e8e1d5fe26922e4ca671d", applicationVersion: "0.5.1",
