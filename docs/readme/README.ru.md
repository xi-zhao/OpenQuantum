...
Скачайте установщик для Mac (Apple Silicon / Intel) или Windows из [GitHub Releases](https://github.com/xi-zhao/OpenQuantum/releases/latest). Node.js и uv входят в комплект; сборка из исходников не нужна. Это тестовые сборки без цифровой подписи. Следуйте [инструкции по установке](../DESKTOP_INSTALLERS.md), откройте приложение и настройте модель. Некоторые зависимости Python загружаются при первом использовании; Quantum Learning и другие дополнительные приложения требуют отдельной подготовки.

[Установщики v0.5.1](../releases/v0.5.1.md) не содержат возможностей, добавленных в `main` позднее, и [обновлений квантовых библиотек от 22 сентября](../releases/2026-09-22-quantum-upstream-update.md). Изменения исходного кода не обновляют установленное приложение автоматически.
